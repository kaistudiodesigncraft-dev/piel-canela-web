  ...
  combos: [
    {
      ...
      extras: [{ id: "70000000-0000-4000-8000-000000000001", treatmentId: "40000000-0000-4000-8000-000000000099", name: "Zona extra", description: "", audience: "shared", priceCents: 500000, durationMinutes: 10, displayOrder: 1, isActive: true }],
      displayOrder: 1,
      isActive: true,
    },
    {
      ...
      pricingMode: "fixed_price", discountPercent: null, tierMinItems: null, tierDiscountPercent: null, allowPublicExtras: false,
